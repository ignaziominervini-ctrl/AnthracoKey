...
[AnthracoForm](https://doi.org/10.5281/zenodo.20487674). It is a self-contained
...
> https://doi.org/XX.XXXX/zenodo.XXXXXXXX

*(Replace the DOI above with the one Zenodo assigns to this release.)*
...
- [AnthracoForm](https://doi.org/10.5281/zenodo.20487674) — the upstream
